-- Reconcile the claimed preview database that received an earlier draft of
-- 0001_initial.sql. The six application tables were verified empty before this
-- migration was authored; keep this migration monotonic instead of rewriting
-- the already-recorded 0001 migration.

DROP TABLE IF EXISTS receipt_events;
...
CREATE INDEX executions_session_queue
...
CREATE INDEX receipt_events_execution
